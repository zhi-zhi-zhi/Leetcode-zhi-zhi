...
describe('AvlTree', () => {
  ...
  it('should keep parent correctly 1', () => {
    const tree = new AvlTree();
    ...
    expect(tree.toString()).toBe('0,1,2,3,4');
    // expect(tree.root.find(1).parent).toBe(0);
  });

  it('should keep parent correctly 2', () => {
    const tree = new AvlTree();
  ...
  it('should keep parent correctly 3', () => {
    const tree = new AvlTree();
    ...
    tree.remove(3)
    // console.log(tree.root)
    expect(tree.toString()).toBe('0,1,2,4,5,6,7');
    // expect(tree.root.find(1).parent).toBe(0);
  });
});
